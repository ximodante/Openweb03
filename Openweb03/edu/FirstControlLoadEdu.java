...
import openadmin.dao.operation.LogDaoEdu;
import openadmin.dao.operation.LogOperationFacadeEdu;
...
public class FirstControlLoadEdu {
	...
	private DaoOperationFacadeEdu connectionLog = null;	
	private LogOperationFacadeEdu log =null; 
	...
	private  List<ClassAndFieldsEdu> getConfigContent() throws FileNotFoundException, IOException{
	...
	public void dataLoad()
		...
		props =PropertyUtilsEdu.getProperties(FileUtilsEdu.getStreamFromWebContentFolder(PropertyPath));
		...
		connection = new DaoJpaEdu(firstLoadUser, "control_post", log,langType);
	 ...
	 * @throws RuntimeException
	 */
	private void  populateClass(ClassAndFieldsEdu cf, int i) 
		...
		fileName=FileUtilsEdu.getPathFromWebContentFolder(fileName);
	...
	public static void main(String[] args) {
		try {
			...
			new FirstControlLoadEdu().dataLoad();
