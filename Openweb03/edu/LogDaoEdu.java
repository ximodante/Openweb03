 ...
 * Modified 06-11-2017 
*/
public class LogDaoEdu implements Serializable, LogOperationFacadeEdu{
	
	private static final long serialVersionUID = 06111703L;
	
	/** Field with database connection*/
	private DaoOperationFacadeEdu connectDao = null;
	...
	private int lenPerson=ReflectionUtilsEdu.sizeAnnotated(LogEdu.class, "person"); 
	...
	/**
	  ...
	  */
	public LogDaoEdu(DaoOperationFacadeEdu pConnect, String pProgram, LangType pLangType){
	...
	private Set<Detail> analyzerAttribute(LogEdu log){
